...
export const metadata: Metadata = {
  ...
  description: 'Harness the power of the sun with Lavan Solar Systems. Reliable, affordable Solar PV installations for homes and businesses in Kenya.',
};
  ...
  return (
    <div className="pt-36 md:pt-40 bg-white">
      <section className="relative h-[400px] overflow-hidden">
        <Image src="/images/projects/kajiado-commercialSolar.webp" alt="Solar PV" fill className="object-cover" />
